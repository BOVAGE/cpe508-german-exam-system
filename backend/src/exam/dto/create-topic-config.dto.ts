...
export class CreateExamTopicConfigDto {
  @ApiProperty({
    description: 'The ID (UUID) of the exam',
  ...
  @ApiProperty({
    description: 'The ID (UUID) of the topic to distribute',
  ...
  @ApiProperty({
    description:
      'The number of questions to select randomly from this topic for attempts',
    minimum: 1,
    example: 5,
  })
  @IsInt()
